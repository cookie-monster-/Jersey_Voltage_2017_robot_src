...
public class CheesyDriveHelper {
  ...
  private DriveBaseSimple drive;
  double oldWheel, quickStopAccumulator;
  private double throttleDeadband = 0.02;
  private double wheelDeadband = 0.02;

  public CheesyDriveHelper(DriveBaseSimple drive) {
    this.drive = drive;
  }
  ...
  public void cheesyDrive(double throttle, double wheel, boolean isQuickTurn, boolean isHighGear) {
    ...
    if (isHighGear) {
      ...
      sensitivity = RobotMap.DRIVE_SENSITIVIY_HIGH;
    } else {
      ...
      sensitivity = RobotMap.DRIVE_SENSITIVIY_LOW;
    }
